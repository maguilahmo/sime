class SchoolsController < ApplicationController
  ...
  private
    ...
    def school_params
      params.require(:school).permit(:cct, :nombre, :turno, :nivel, :subnivel, :detalle, :matricula, :docentes, :p_de_apoyo, :calle, :numero, :entre_calle, :y_calle, :colonia, :municipio, :localidad, :ambito, :zona_esc, :sector, :latitud, :longitud)
    end
end
